# -*- coding: utf-8 -*-
"""
Created on Mon Dec 18 20:38:53 2017
http://blog.csdn.net/u013082989/article/details/73469095
@author: lankuohsing
"""
...
'''
超参数
这里num_steps=5就是只能记忆5步, 所以只能学习到一个依赖(因为至少8步才能学到第二个依赖)，
我们看结果最后的cross entropy是否在0.52左右
'''
num_steps = 10
batch_size = 200
num_classes = 2
