...
def get_train_data(batch_size=60,time_step=20,train_begin=0,train_end=5800):
    ...
    return batch_index,train_x,train_y,normalized_train_data
# In[]
batch_index,train_x,train_y,normalized_train_data=get_train_data()
...
def train_lstm(batch_size=60,time_step=20,train_begin=2000,train_end=5800):
    ...
    batch_index,train_x,train_y,normalized_train_data=get_train_data(batch_size,time_step,train_begin,train_end)
